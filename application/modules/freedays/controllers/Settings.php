...
{
    protected $permissionCreate = 'Freedays.Settings.Create';
    protected $permissionDelete = 'Freedays.Settings.Delete';
    protected $permissionEdit   = 'Freedays.Settings.Edit';
    protected $permissionView   = 'Freedays.Settings.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_freedays()) {
                ...
                redirect(SITE_AREA . '/settings/freedays');
            }
