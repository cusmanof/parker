...
{
    protected $permissionCreate = 'Freedays.Reports.Create';
    protected $permissionDelete = 'Freedays.Reports.Delete';
    protected $permissionEdit   = 'Freedays.Reports.Edit';
    protected $permissionView   = 'Freedays.Reports.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_freedays()) {
                ...
                redirect(SITE_AREA . '/reports/freedays');
            }
