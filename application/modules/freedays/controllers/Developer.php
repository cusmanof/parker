...
{
    protected $permissionCreate = 'Freedays.Developer.Create';
    protected $permissionDelete = 'Freedays.Developer.Delete';
    protected $permissionEdit   = 'Freedays.Developer.Edit';
    protected $permissionView   = 'Freedays.Developer.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_freedays()) {
                ...
                redirect(SITE_AREA . '/developer/freedays');
            }
