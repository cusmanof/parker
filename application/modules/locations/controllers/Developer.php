...
{
    protected $permissionCreate = 'Locations.Developer.Create';
    protected $permissionDelete = 'Locations.Developer.Delete';
    protected $permissionEdit   = 'Locations.Developer.Edit';
    protected $permissionView   = 'Locations.Developer.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_locations()) {
                ...
                redirect(SITE_AREA . '/developer/locations');
            }
