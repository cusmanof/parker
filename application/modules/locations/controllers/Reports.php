...
{
    protected $permissionCreate = 'Locations.Reports.Create';
    protected $permissionDelete = 'Locations.Reports.Delete';
    protected $permissionEdit   = 'Locations.Reports.Edit';
    protected $permissionView   = 'Locations.Reports.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_locations()) {
                ...
                redirect(SITE_AREA . '/reports/locations');
            }
