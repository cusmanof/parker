...
{
    protected $permissionCreate = 'Locations.Content.Create';
    protected $permissionDelete = 'Locations.Content.Delete';
    protected $permissionEdit   = 'Locations.Content.Edit';
    protected $permissionView   = 'Locations.Content.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_locations()) {
                ...
                redirect(SITE_AREA . '/content/locations');
            }
