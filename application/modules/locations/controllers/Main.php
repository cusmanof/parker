...
{
    protected $permissionCreate = 'Locations.Main.Create';
    protected $permissionDelete = 'Locations.Main.Delete';
    protected $permissionEdit   = 'Locations.Main.Edit';
    protected $permissionView   = 'Locations.Main.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_locations()) {
                ...
                redirect(SITE_AREA . '/main/locations');
            }
