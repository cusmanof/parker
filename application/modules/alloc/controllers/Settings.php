...
{
    protected $permissionCreate = 'Alloc.Settings.Create';
    protected $permissionDelete = 'Alloc.Settings.Delete';
    protected $permissionEdit   = 'Alloc.Settings.Edit';
    protected $permissionView   = 'Alloc.Settings.View';
    ...
    public function edit()
    {
        ...
        if (empty($id)) {
            ...
            redirect(SITE_AREA . '/settings/alloc');
        }
