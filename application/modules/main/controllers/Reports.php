...
{
    protected $permissionCreate = 'Main.Reports.Create';
    protected $permissionDelete = 'Main.Reports.Delete';
    protected $permissionEdit   = 'Main.Reports.Edit';
    protected $permissionView   = 'Main.Reports.View';
