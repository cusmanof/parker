...
{
    protected $permissionCreate = 'About.Main.Create';
    protected $permissionDelete = 'About.Main.Delete';
    protected $permissionEdit   = 'About.Main.Edit';
    protected $permissionView   = 'About.Main.View';
