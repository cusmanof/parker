...
{
    protected $permissionCreate = 'About.Developer.Create';
    protected $permissionDelete = 'About.Developer.Delete';
    protected $permissionEdit   = 'About.Developer.Edit';
    protected $permissionView   = 'About.Developer.View';
