...
{
    protected $permissionCreate = 'Year.Reports.Create';
    protected $permissionDelete = 'Year.Reports.Delete';
    protected $permissionEdit   = 'Year.Reports.Edit';
    protected $permissionView   = 'Year.Reports.View';
    ...
    public function edit()
    {
        ...
        if (empty($id)) {
            ...
            redirect(SITE_AREA . '/reports/year');
        }
